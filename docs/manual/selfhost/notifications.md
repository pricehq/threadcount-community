...
request is approved or declined, when a bag is ready to collect, when it goes out on the ward round,
...
A notification body is drawn on a phone's lock screen, where anyone walking past a ward desk can
