    ...
    <>
      ...
      <MBody>
        <div style={{ padding: "16px 16px 0" }}>
          <Kicker>{cap(terms.teams)} see words, not counts</Kicker>
        ...
        <div style={{ padding: "0 16px" }}>
          ...
          <p style={{ fontSize: 13, lineHeight: 1.6, color: N700, padding: "16px 0 0", margin: 0 }}>
            Availability comes from the last {terms.store} stocktake{counted ? ` — most recently ${fmtDate(counted)}` : ""}.
          </p>
        </div>
        <div style={{ height: 12 }} />
      </MBody>
