...
export type Settings = {
  ...
  /** The organisation's own words for team, store, round and desk, always complete — see lib/terms.ts.
   *  Every screen that names one of those four things reads it from here. */
  terms: import("./terms").Terms;
