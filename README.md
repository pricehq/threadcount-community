...
ready-to-collect notices by email. Without them ThreadCount still works; those things happen at
...
`NEXT_PUBLIC_TERMS_URL` and `NEXT_PUBLIC_PRIVACY_URL` (point the in-app terms and privacy links
