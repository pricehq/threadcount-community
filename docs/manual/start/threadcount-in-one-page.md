...
| `Settings` | Six sections: Facility, Issuing rules, Catalogue & suppliers, Places & cost centres, People & sign-in, and Data & audit log. |
...
The people who run the uniform store sign in as users, and each user has one of two roles.
