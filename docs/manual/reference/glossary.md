...
role: Anyone
keywords: glossary, terms, definitions, words, meaning, vocabulary, what does it mean, audit log, to order, override, team, team desk, uniform store, ward, linen room
---
...
**Cost centre** — The finance code a team's issues are [charged to](/docs/reports/cost-centres).

**Cost centre override** — A [cost centre](/docs/reports/cost-centres) on one person's record, used instead of their team's.
...
**Delivery round** — Bags taken out to the teams: pickups signed for on screen, from `Deliver on the delivery round` on `Today`, and approved requests signed for at the team desk. See [delivery rounds](/docs/counter/delivery-rounds).

**Department** — What the CSV imports (`dept`) and the journal's `Department` column call a team. See [cost centres](/docs/reports/cost-centres).
...
**Team** — The group a person belongs to and is charged to, with its [cost centre](/docs/reports/cost-centres), under `Settings › Places & cost centres`.

**Team desk** — `On the team desk` on a staff record, letting that person sign in the staff app for request bags the delivery round leaves at their team. See [delivery rounds](/docs/counter/delivery-rounds).
...
**Uniform store** — Where stock is kept and handed out from, and the people who run it. See [your words](/docs/start/your-words).
...
**Ward, ward round, ward desk, linen room** — The words the `Hospital or healthcare` starting point uses for team, delivery round, team desk and uniform store. See [your words](/docs/start/your-words).

**Words** — The five words the screens, slips and emails use for a team, teams, the uniform store, the delivery round and the team desk, set under `Settings › Facility`. See [your words](/docs/start/your-words).
