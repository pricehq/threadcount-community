...
This covers the Community edition published at
[github.com/pricehq/threadcount-community](https://github.com/pricehq/threadcount-community).
The hosted service's own code — the website, billing, single sign-on and the tooling behind it —
is not published and is not covered by this licence. The **ThreadCount name and logo** are not
licensed either; a fork needs its own name.

If the AGPL does not suit your organisation, a commercial licence for the same code is available:
kyle@threadcount.tech.
