      ...
      <MBody>
        ...
        {tab === "holding" && (
          <div style={{ padding: "0 16px" }}>
            {data.held.length === 0 ? (
              <MEmpty title="Nothing on your record" sub={`Anything the ${terms.store} issues you shows up here.`} />
            ) : (
              data.held.map((h) => (
                <MRow
                  key={`${h.itemId}:${h.si}`}
        ...
        {tab === "sizes" && (
          <div style={{ padding: "0 16px" }}>
            ...
            <div style={{ padding: "18px 0 6px", fontSize: 14, color: N600, lineHeight: 1.5 }}>
              The {terms.store} records these. Tell them below if they are wrong.
            </div>
        ...
        {sent && (
          <div style={{ margin: 16, background: INK, color: "var(--color-bg)", padding: 16, fontSize: 14, lineHeight: 1.5 }}>
            Sent. The {terms.store} will look at your record and come back to you.
          </div>
        )}
        ...
        {disputing && !sent && (
          <div style={{ padding: 16, borderTop: "2px solid " + INK }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 12, flexWrap: "wrap" }}>
              ...
              >{busy ? "Sending…" : `Send to the ${terms.store}`}</button>
