...
- Links: `[text](/docs/stock/barcodes)` to other manual pages, `[text](/security)` to the site.
...
A manual link is `/docs/<section>/<slug>`. Site pages you may also link: `/`, `/product`,
`/compare`, `/docs`, `/security`, `/data-security`, `/privacy`, `/delete-account`, `/changelog`,
