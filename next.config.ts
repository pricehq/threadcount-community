...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    const site = process.env.EDITION === "community" ? [] : [
      ...
      { source: "/sla", destination: "/security", permanent: true },
      { source: "/acceptable-use", destination: "/security", permanent: true },
      { source: "/security/questionnaire", destination: "/security", permanent: true },
      { source: "/security/data-processing-terms", destination: "/security", permanent: true },
