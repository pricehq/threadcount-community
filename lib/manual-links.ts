...
export const SECTIONS = [
  ...
  { id: "account", title: "Account", blurb: "Users, two-factor, backups, exports and deleting an account." },
  { id: "selfhost", title: "Self-hosting", blurb: "Installing it on your own server, updating, backups, email and configuration." },
